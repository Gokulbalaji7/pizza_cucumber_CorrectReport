...
// chromedriver launch
	public static WebDriver chromedriverlaunch() {
		
       // below is new version for chrome
...
// edgedriver launch
		public static WebDriver edgedriverlaunch() {
	...
	// screenshot in syntax folderlocation type must anyname.png after location in
	// end.

	public static void screenshott(String folderlocationthenaddlastdoubleslashnamedotpng) throws IOException, Throwable {
...
//				above line or below line any one give , 
		...
		// if below line given means we cannot add any jar files referenced libraries
		// just give this line it is easy to take screenshot
	...
	public static void implicitywaitss() {
